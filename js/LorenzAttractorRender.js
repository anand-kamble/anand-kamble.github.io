...
const init = () => {
  ...
  const RENDERER_SCALE_WRT_SCREEN = window.location.href.includes(
    "Lorenz-Attractor"
  )
    ? 1
    : 0.8;
  ...
  renderer.setSize(
    window.innerWidth * RENDERER_SCALE_WRT_SCREEN,
    window.innerHeight * RENDERER_SCALE_WRT_SCREEN
  );

  const rendererHolder = document.getElementById("lorenzAttractorHolder");
